...
<body>
    ...
    <div class="button-layout">
        <a href="../form/gruppeform.php"><button type="button" class="button btn-primary">Hinzufügen</button></a>
        <a href="../form/gruppeform.php"><button type="button" class="button">Bearbeiten</button></a>
